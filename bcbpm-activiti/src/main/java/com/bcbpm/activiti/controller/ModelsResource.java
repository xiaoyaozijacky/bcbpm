...
import com.bcbpm.model.editor.decisiontable.DecisionTableDefinitionRepresentation;
...
public class ModelsResource extends AbstractModelsResource{
    ...
    public String importProcessModelText(HttpServletRequest request, @RequestParam("file") MultipartFile file){
        ...
        try{
            ...
            throw new BusinessException("Model Representation could not be saved");
        }
    ...
    public ModelRepresentation createModel(@RequestBody ModelRepresentation modelRepresentation){
        ...
        if(modelKeyInfo.isKeyAlreadyExists()){
            throw new BusinessException("Provided model key already exists: " + modelRepresentation.getKey());
        }
        ...
        if(modelRepresentation.getModelType() != null && modelRepresentation.getModelType().equals(AbstractModel.MODEL_TYPE_FORM)){
            try{
                ...
                throw new BusinessException("Error creating form");
            }
            ...
            try{
                ...
                throw new BusinessException("Error creating decision table");
            }
            ...
            try{
                ...
                throw new BusinessException("Error creating app definition");
            }
        ...
        Model newModel = modelService.createModel(modelRepresentation, json, (User) sessionDeal.getNowUserFront());
    ...
    public ModelRepresentation duplicateModel(@PathVariable String modelId, @RequestBody ModelRepresentation modelRepresentation){
        ...
        if(model == null){
            throw new BusinessException("Error duplicating model : Unknown original model");
        }
        ...
        newModel = modelService.saveModel(newModel, newModel.getModelEditorJson(), imageBytes, false, newModel.getComment(), (User) sessionDeal.getNowUserFront());
    ...
    protected ObjectNode deleteEmbededReferencesFromBPMNModel(ObjectNode editorJsonNode){
        try{
            ...
            throw new BusinessException("Cannot delete the external references");
        }
    }
