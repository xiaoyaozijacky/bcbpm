...
public final class DateUtil{
    ...
    /**
     * 	获得系统中使用长整形表示的日期 
     * 返回参数：long:表示的日期的8位长整形值 如：20090723
     */
    ...
    /**
     * 	长整形时间类组合Calender，封装Calender的数字接口和方法
     *  返回 20090802080808 包含日期和时间
     * 
     */
    ...
    /**
     *	由长整型时间变为字符 
     *	通过长整数变为时间格式,可以自动适应8位或16位
     *	输入："20090808"或"20090808080808"
    ...
    /**
     * 得到系统当前时间 
     * 返回参数：String:系统当前时间 格式：yyyy/mm/dd
     */
    ...
    /**
     * 得到给定时间显示，格式：yyyy/mm/dd 
     * 参数格式："20090808"或"20090808080808"
     */
    ...
    /**
     * 由长整型时间变为字符 
     * 通过长整数变为时间格式,输入参数为6位的时间 如"123143"
     * 返回格式：12点31分43秒
     */
    ...
    /**
     * 返回正常日－处理３０／３１／２８ 输入参数：long calendar 当前时间, int
     * intWeek 间隔星期 返回值： long:处理后的时间
     */
    ...
    */
    ...
    //     * @Author:       [jacky]     
    //     * @Company:      [xhnj]
    //     * @param:        [List 集合,dataSty时间格式]
    //     * @Description:  [处理array时间格式转到前台为字符串] 
    //     *
    //     */
    //    public static String delArrayData(List<?> l, String dataSty){
    //        JsonConfig config = new JsonConfig();
    //        config.registerJsonValueProcessor(Timestamp.class, new DateJsonValueProcessor(dataSty));
    //        JSONArray object = JSONArray.fromObject(l, config);
    ...
    //     * @Author:       [jacky]     
    //     * @Company:      [xhnj]
    //     * @param:        [Object 对象,dataSty时间格式]
    //     * @Description:  [处理对象时间格式转到前台为字符串] 
    //     *
    //     */
    //    public static String delObjData(Object o, String dataSty){
    //        JsonConfig config = new JsonConfig();
    //        config.registerJsonValueProcessor(Timestamp.class, new DateJsonValueProcessor(dataSty));
    //        JSONObject object = JSONObject.fromObject(o, config);
    //        return JsonUtil.getJsonStr(object);
    //    }

    public static void main(String[] args) throws ParseException{
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        System.out.println(df.parse("2017-02-10").getTime() < df.parse("2017-02-11").getTime());

        //        for(String month : getMonthBetween("2017-02-10", "2017-12-02")){
